#!/usr/bin/env python3
"""Reconcile DownloaderBot's two databases (e.g. your laptop's local DB and its
...
PLAIN_TABLES = [
    ...
    {"name": "settings", "key": ("user_id",),
     "cols": ["user_id", "caption_enabled", "language"]},
]
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Merge DownloaderBot's two databases together, additive-only.")
